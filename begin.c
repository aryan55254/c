...
//general purpose and portable(can be run on diff hardware and os with min or no modification) 
//low level memory access
//fast 
#include <stdio.h>
//header contains functional declarations and macro definitions shared between all source files 
